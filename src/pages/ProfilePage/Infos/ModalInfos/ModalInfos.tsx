...
function ModalInfos({ isOpen, formData, handleChange, handleReset, handleSubmit }: ModalInfosProps) {
        ...
        <div ref={modalInfos} className="modalInfo">
          <form className="modalInfo_form" onSubmit={handleSubmit} onReset={handleReset}>
            ...
            <div className="modalInfo_container">
              <Input name='firstname' type='text' text='Prénom' backWhite required handleChange={handleChange} value={formData.firstname} modal="infos" />
              <Input name='lastname' type='text' text='Nom' backWhite required handleChange={handleChange} value={formData.lastname} modal="infos" />
            </div>

            <Input name='email' type='text' text='email' backWhite handleChange={handleChange} value={formData.email} modal="infos" disabled />
