  ...
  return (
    <div className='cartPage'>
      <div className="cartPage_title">
        <span className="cartPage_title_question">Comment pouvons-nous vous aider ?</span>
        <h1 className="cartPage_title_text">Restons connectés</h1>
        <span className="cartPage_title_description">N'hésitez pas à nous contacter !</span>
      </div>
      <form className="cartPage_form">
        <div className="cartPage_form_top">
        ...
        <button type="submit" className="cartPage_form_button">Envoyer</button>
      </form>
    </div>
  )
